    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">人力资源管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                       ...
                       <el-form-item class="select" label="部门">
                            <el-select style="width: 300px" v-model="ruleForm.bumenId" placeholder="请选择部门">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 员工 的 部门
                            // if((!this.ruleForm.bumenId)&& 'yuangong'==this.tableName){
