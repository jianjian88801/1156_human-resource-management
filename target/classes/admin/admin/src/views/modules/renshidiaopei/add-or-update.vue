    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yuangong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="职位" prop="zhiwei">
                        <el-input v-model="yuangongForm.zhiwei"
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="人事调配名称" prop="renshidiaopeiName">
                       <el-input v-model="ruleForm.renshidiaopeiName"
                                 placeholder="人事调配名称" clearable  :readonly="ro.renshidiaopeiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="人事调配名称" prop="renshidiaopeiName">
                           <el-input v-model="ruleForm.renshidiaopeiName"
                                     placeholder="人事调配名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="调配详情" prop="renshidiaopeiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.renshidiaopeiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.renshidiaopeiContent" label="调配详情" prop="renshidiaopeiContent">
                            <span v-html="ruleForm.renshidiaopeiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="调配时间" prop="diaopeiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.diaopeiTime"
                                type="datetime"
                                placeholder="调配时间"
                                :disabled="ro.diaopeiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.diaopeiTime" label="调配时间" prop="diaopeiTime">
                            <span v-html="ruleForm.diaopeiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    renshidiaopeiName: false,
                    renshidiaopeiContent: false,
                    diaopeiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   renshidiaopeiName: [
                              { required: true, message: '人事调配名称不能为空', trigger: 'blur' },
                          ],
                   renshidiaopeiContent: [
                              { required: true, message: '调配详情不能为空', trigger: 'blur' },
                          ],
                   diaopeiTime: [
                              { required: true, message: '调配时间不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`renshidiaopei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.renshidiaopeiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
