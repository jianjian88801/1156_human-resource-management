    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工资名称" prop="gongziName">
                       <el-input v-model="ruleForm.gongziName"
                                 placeholder="工资名称" clearable  :readonly="ro.gongziName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工资名称" prop="gongziName">
                           <el-input v-model="ruleForm.gongziName"
                                     placeholder="工资名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="发放月份" prop="gongziTime">
                        <el-date-picker
                                value-format="yyyy-MM"
                                v-model="ruleForm.gongziTime"
                                type="month"
                                placeholder="发放月份"
                                :disabled="ro.gongziTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongziTime" label="发放月份" prop="gongziTime">
                            <span v-html="ruleForm.gongziTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="奖金" prop="jiangjinGongzi">
                       <el-input v-model="ruleForm.jiangjinGongzi"
                                 placeholder="奖金" clearable  :readonly="ro.jiangjinGongzi"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="奖金" prop="jiangjinGongzi">
                           <el-input v-model="ruleForm.jiangjinGongzi"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="gongziContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gongziContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongziContent" label="备注" prop="gongziContent">
                            <span v-html="ruleForm.gongziContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   gongziName: [
                              { required: true, message: '工资名称不能为空', trigger: 'blur' },
                          ],
                   gongziTime: [
