<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='部门名称' prop="bumenName">
                 <el-input v-model="ruleForm.bumenName" :disabled="true" placeholder="部门名称"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='部门人数' prop="bumenNumber">
                 <el-input v-model="ruleForm.bumenNumber" :disabled="true" placeholder="部门人数"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='部门职责' prop="bumenZhize">
                 <el-input v-model="ruleForm.bumenZhize" :disabled="true" placeholder="部门职责"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.bumenId)&& 'yuangong'==this.flag){
