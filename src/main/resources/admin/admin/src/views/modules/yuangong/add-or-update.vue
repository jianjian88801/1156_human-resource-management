        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='bumen'">
                    <el-form-item class="select" v-if="type!='info'"  label="部门" prop="bumenId">
                        <el-select v-model="ruleForm.bumenId" :disabled="ro.bumenId" filterable placeholder="请选择部门" @change="bumenChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='bumen' ">
                    <el-form-item class="input" v-if="type!='info'"  label="部门人数" prop="bumenNumber">
                        <el-input v-model="bumenForm.bumenNumber"
                                  placeholder="部门人数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="部门人数" prop="bumenNumber">
                            <el-input v-model="ruleForm.bumenNumber"
                                      placeholder="部门人数" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='bumen' ">
                    <el-form-item class="input" v-if="type!='info'"  label="部门职责" prop="bumenZhize">
                        <el-input v-model="bumenForm.bumenZhize"
                                  placeholder="部门职责" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="部门职责" prop="bumenZhize">
                            <el-input v-model="ruleForm.bumenZhize"
                                      placeholder="部门职责" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工编号" prop="yuangongUuidNumber">
                       <el-input v-model="ruleForm.yuangongUuidNumber"
                                 placeholder="员工编号" clearable  :readonly="ro.yuangongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
