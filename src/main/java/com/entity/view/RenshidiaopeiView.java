...
public class RenshidiaopeiView extends RenshidiaopeiEntity implements Serializable {
	...
	public RenshidiaopeiView() {

	}

	public RenshidiaopeiView(RenshidiaopeiEntity renshidiaopeiEntity) {
		try {
			BeanUtils.copyProperties(this, renshidiaopeiEntity);
